define(['jquery', 'settings-core', 'json!settings-general'], function($, CoreSettings, GeneralSettings) {
   ...
   return {
      ...
      //MICRO_LEARNING FIX, SCROLL BACK PAGE TOTOP ON MOBILE TO STOP SECTIONS FROM NOT APPEARING ON NEXT ONE - CSPS-TD
      scrollToTopIfMob: function(){
         if($('html').hasClass('mobile')){
            $('main[role=main]').scrollTop(0);
         }
      }

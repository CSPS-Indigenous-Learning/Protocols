define([
...
], function(Logger, CoreSettings, GeneralSettings, BaseModule, ObjSubUtils) {
	'use strict';
	...
	return BaseModule.extend({
		...
		updateViewed: function() {
			...
			if (GeneralSettings.triggerCompletionWhenAllPagesViewed) { //CSPS-SJ && CSPS-TD	
			...
			if (masterStructure.isLastOfLevel() <= CoreSettings.loopLevel && GeneralSettings.markModuleAsViewedOnLastPage) {
				masterStructure.levels[0].subs[masterStructure.currentSub.aPosition[0]].setViewedSubs();
			}
			var stringViewed = "";

define([
	...
	'json!ga-List',
	'logger'
], function(_, $, BaseModule, GeneralSettings, Utils, AnalyticsList, Logger) {
	'use strict';
	...
	return BaseModule.extend({
		...
		gaTracker: function (){
			...
			window.ga=window.ga||function(){(ga.q=ga.q||[]).push(arguments)};ga.l=+new Date;
      		ga('create', GeneralSettings.googleAnalyticsID , 'auto');
			var path = Utils.lang + '/' + masterStructure.currentNav.join();
